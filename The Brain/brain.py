    ...
    def movegrp(self, i, camp):
        ...
        if camp==1:
            ...
            for j in range(Map.werewolf[i][0]):
                maps+=[tempmap.movewerewolf(tempmap,j,coordX-1,coordY+1)]
                maps+=[tempmap.movewerewolf(tempmap,j,coordX+1,coordY)]
                maps+=[tempmap.movewerewolf(tempmap,j,coordX-1,coordY)]
                maps+=[tempmap.movewerewolf(tempmap,j,coordX,coordY+1)]
                maps+=[tempmap.movewerewolf(tempmap,j,coordX,coordY-1)]
                maps+=[tempmap.movewerewolf(tempmap,j,coordX+1,coordY+1)]
                maps+=[tempmap.movewerewolf(tempmap,j,coordX-1,coordY-1)]
                maps+=[tempmap.movewerewolf(tempmap,j,coordX+1,coordY-1)]
            ...
            for j in range(Map.vampire[i][0]):
                maps += [tempmap.movevampire(tempmap, j, coordX+1, coordY)]
                maps += [tempmap.movevampire(tempmap, j, coordX-1, coordY)]
                maps += [tempmap.movevampire(tempmap, j, coordX, coordY+1)]
                maps += [tempmap.movevampire(tempmap, j, coordX, coordY-1)]
                maps += [tempmap.movevampire(tempmap, j, coordX+1, coordY+1)]
                maps += [tempmap.movevampire(tempmap, j, coordX-1, coordY-1)]
                maps += [tempmap.movevampire(tempmap, j, coordX+1, coordY-1)]
                maps += [tempmap.movevampire(tempmap, j, coordX-1, coordY+1)]
        return maps
